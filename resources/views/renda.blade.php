...
<nav>
    ...
    <div class="nav-links">
        <a href="{{ route('cadastrar_renda') }}"><button class="nav-links-button">lp</button></a>
        <a href="{{ route('cadastrar_renda') }}"><button class="nav-links-button">+</button></a>
